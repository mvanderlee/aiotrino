...
@pytest.fixture
async def mock_get_and_post():
    post = AsyncMock()
    get = AsyncMock()

    with patch("aiotrino.client.TrinoRequest.http") as mock_aiohttp:
        mock_aiohttp.ClientSession.return_value.get = get
        mock_aiohttp.ClientSession.return_value.post = post
